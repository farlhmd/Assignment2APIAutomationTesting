...
<WebServiceRequestEntity>
   ...
   <name>Get Specific Todo by Id</name>
   <tag></tag>
   <elementGuidId>43ea3c8e-5b2e-4424-ba7f-af48fe0bd9dc</elementGuidId>
   ...
   <restUrl>${GlobalVariable.url}/todos/${GlobalVariable.id}</restUrl>
