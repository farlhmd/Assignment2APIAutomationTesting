...
WS.comment('To check all Albums from 10 Users, use for loop (Variable declared) on Global Variables')
...
for (int idLocal = 1; idLocal <= 10; idLocal++) {
    ...
    response = WS.sendRequest(findTestObject('EP_Users/Get all Albums from specific User'))
