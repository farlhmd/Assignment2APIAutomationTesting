...
response = WS.sendRequest(findTestObject('EP_Todos/Post a Todo'))
...
bodyVerified = WS.verifyElementPropertyValue(response, 'completed', completed, FailureHandling.OPTIONAL)
